# -*- coding: utf-8 -*-
"""
Created on Sat Mar  2 15:08:09 2019
...
pollens_path = "E:/tensorflow_data/pollens/"
...
#读取训练数据及测试数据            
pollens_data,pollens_label = read_image(pollens_path)

#%%
##分为训练集和测试集
pollens_image_num = len(pollens_data)
pollens_image_index = np.arange(pollens_image_num)
train_index, test_index = train_test_split(pollens_image_index, test_size = 0.3)
train_data = pollens_data[train_index]
train_label = pollens_label[train_index] 
test_data = pollens_data[test_index]
test_label = pollens_label[test_index]
...
with tf.Session() as sess:
    ...
    for i in range(train_num):
        ...
        print("train_loss:",train_loss/batch_num)
        print("train_acc :",train_acc/batch_num)
        ...
        #if train_step%100==0:
        print("test_loss:",test_loss/batch_num)
        print("test_acc :",test_acc/batch_num)    
        print("")